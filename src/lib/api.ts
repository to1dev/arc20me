...
async function fetchRealmAtomicalId(
    realm: string
...
async function fetchRealmInfo(id: string): Promise<{ info: Info | null }> {
    const baseUrl = PUBLIC_ELECTRUMX_BASE_URL;
...
async function fetchRealmProfile(
    id: string
...
export async function fetchResult(
    realm: string
): Promise<{ realm: Realm | null | null; profile: Content | null }> {
