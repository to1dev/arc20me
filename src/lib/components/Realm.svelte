...
>
    <div
        class="container m-4 lg:w-2/6 xl:w-2/7 sm:w-full md:w-2/3 shadow-2xl transform duration-200 easy-in-out border-2 border-white rounded-t-xl"
    >
        ...
        <div class="bg-white">
            ...
            <div class="flex bg-gray-50">
                <div
                    class="flex justify-center items-center w-1/2 p-4 hover:bg-gray-100 cursor-pointer duration-200"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
