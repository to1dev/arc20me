...
{#if meta?.id && !meta?.pid}
    ...
    <div>
        <button
            class="duration-150 py-2 px-3 inline-flex justify-center items-center w-28 gap-x-2 text-base font-semibold rounded-full bg-blue-500 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
        >
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
