            ...
            {#each Object.entries(group?.items) as [_, item], index}
                ...
                >
                    {#if item?.type === "x"}<svg
                        ...
                        >{:else if item?.type === "telegram"}<svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                        ...
                        >{:else if item?.type === "nostr"}<svg
                            ...
                            /></svg
                        >{:else if item?.type === "instagram"}<svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
